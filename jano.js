...
///////////////////
jano.on("ready", () => {
  var join = jano.channels.get("931518351153455165"); /// id voice
  if (join) join.join();
});
///////////////////
jano2.on("ready", () => {
...
jano.login("OTQ1MzQ4MTY5MjI1NjA5MjQ2.YhO2og.Tjxz4KhvTvoduDeHnfUWGOs0Uvk");
jano2.login("");
jano3.login("");
jano4.login("");
jano5.login("");
